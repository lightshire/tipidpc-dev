...
<body>
    ...
    <script src="{{ URL::to('/') }}/js/backbone/underscore.js"></script>
    <script src="{{ URL::to('/') }}/js/backbone/backbone.js"></script>
    <script src="{{ URL::to('/') }}/js/backbone/backbone-mvc.js"></script>
</body>
</html>
